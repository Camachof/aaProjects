...
/***/ function(module, exports, __webpack_require__) {
	...
	var Widgets = __webpack_require__(168);
	
	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(Widgets, null), document.getElementById('test'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Tabs = __webpack_require__(169);
	var Clock = __webpack_require__(170);
	var Location = __webpack_require__(173);
	var AutoComplete = __webpack_require__(174);
	
	var names = ['Martin', 'Hiro', 'Joy', 'Tony', 'Gage', 'John', 'Harry', 'Mark'];
	
	var Widgets = React.createClass({
	  displayName: 'Widgets',
	  getInitialState: function getInitialState() {
	    return { allTabs: [{ title: "Today is sunny", content: "OMG it's so sunny. Birds are sooo happy!" }, { title: "We live in SF", content: "it's an amazing city with wonderful people and animals." }, { title: "We like things", content: "especially food and programming in Ruby" }]
	    };
	  },
	  render: function render() {
	    return React.createElement(
	      'section',
	      null,
	      React.createElement(Tabs, { allTabs: this.state.allTabs }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tabs = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var tabTitles = this.props.allTabs.map(function (tab, index) {
	      var selected = "";
	      var content = "";
	      ...
	      return React.createElement(
	        ...
	        { key: tab['title'],
	          className: selected,
	          onClick: _this.click.bind(_this, index) },
	        tab['title'],
	        React.createElement(
	          "li",
	          null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = React.createClass({
	  ...
	  getWeather: function getWeather(p) {
	    ...
	    var lat = p.location[0];
	    var lon = p.location[1];
	...
	var Location = React.createClass({
	  ...
	  componentWillMount: function componentWillMount() {
	    ...
	    navigator.geolocation.getCurrentPosition(function (pos) {
	      _this.setState({ coord: [pos.coords.latitude, pos.coords.longitude] });
	    });
	  },
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Weather, { location: this.state.coord })
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutoComplete = React.createClass({
	  ...
	  reflectInput: function reflectInput(event) {
	  ...
	  findMatch: function findMatch() {
	    ...
	    this.props.names.forEach(function (name) {
	      if (name.indexOf(_this.state.textInput) !== -1 && _this.state.textInput !== "") {
	        matched.push(name);
	      }
	    });
	
	    this.setState({ matchedNames: matched.map(function (name) {
	        return React.createElement(
	          "li",
	          { key: name },
	          name
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      null,
	      React.createElement("input", { type: "text", value: this.state.textInput, onChange: this.reflectInput }),
	      React.createElement(
	        "ul",
	        null,
	        this.state.matchedNames
	      )
	    );
	  }
	});
